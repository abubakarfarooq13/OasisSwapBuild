import{s as g,X as I,aB as k,r as C,k as j,aV as H,j as e,I as M,F as d,T as p,d as a,e as P,bu as v,a_ as y,hN as A,hO as E,gN as _,hP as D,dF as L,g_ as S,b5 as b,aa as w,U as V,hQ as z,dG as W,dI as B,g as f,h2 as G,aA as N,f2 as $,O}from"./index-5ecfe8e3.js";const R=g.div`
  display: flex;
...
`,ee=({shouldShowPinButton:t=!0})=>{const{rawSlippage:n,setRawSlippage:i,isSlippageControlPinned:r,togglePinSlippage:s}=_(),l=D(),c=L(),x=G(n,l,c),o=x!==S.NORMAL,u=j();return e.jsxs(d,{sx:{flexDirection:"column",rowGap:"8px"},children:[e.jsxs(d,{sx:{alignItems:"center"},children:[e.jsx(b,{fontSize:12,fontWeight:400,color:u.subText,underlineColor:u.border,children:e.jsx(w,{text:e.jsx(p,{children:e.jsx(a,{id:"IQ5oQu",components:{0:e.jsx(V,{href:"https://docs.kyberswap.com/getting-started/foundational-topics/decentralized-finance/slippage"})}})}),placement:"right",children:e.jsx(a,{id:"x6GJ4a"})})}),t&&e.jsx(K,{isActive:r,onClick:s})]}),e.jsx(z,{rawSlippage:n,setRawSlippage:i,isWarning:o,defaultRawSlippage:l?W:B}),o&&e.jsx(Q,{"data-warning":!0,"data-error":!1,children:x===S.HIGH?l?f._({id:"hW915/"}):c?f._({id:"/e7qAv"}):f._({id:"3jGUwg"}):f._({id:"SzyXkE"})})]})},T=t=>{const n=Number.parseInt(t,10);return t.length>5||Number.isNaN(n)||String(Math.floor(n))!==t?!1:0<n&&n<1e4},X=({className:t})=>{const n=j(),[i,r]=N(),[s,l]=C.useState(String(Math.floor(i/60))),c=C.useRef(null),x=T(s),o=()=>{if(!T(s))return;const h=parseInt(s,10)*60;r(h)},u=h=>{var m;h.key==="Enter"&&(o(),(m=c.current)==null||m.blur())};return $(c,()=>o()),C.useEffect(()=>{l(String(Math.floor(i/60)))},[i]),e.jsxs(d,{justifyContent:"space-between",alignItems:"center",className:t,children:[e.jsx(d,{alignItems:"center",children:e.jsx(b,{fontSize:12,fontWeight:400,color:n.subText,underlineColor:n.border,children:e.jsx(w,{text:e.jsx(p,{children:e.jsx(a,{id:"DMtNzZ"})}),placement:"right",children:e.jsx(a,{id:"wNtlPc"})})})}),e.jsxs(d,{sx:{height:"28px",fontWeight:500,fontSize:"12px",lineHeight:"16px",columnGap:"2px",alignItems:"center",backgroundColor:n.tabBackground,padding:"0 8px",borderRadius:"40px"},children:[e.jsx(O,{width:60,children:e.jsx("input",{ref:c,className:"input",placeholder:String(i/60),value:s,onChange:h=>l(h.target.value),onBlur:o,onKeyUp:u,"data-valid":x})}),e.jsx(p,{fontWeight:500,fontSize:"12px",lineHeight:"16px",children:e.jsx(a,{id:"3131gY"})})]})]})},te=g(X)`
  .input {
    width: 100%;
