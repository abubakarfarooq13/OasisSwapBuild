import{r as i,j as m,s as e,bm as s}from"./index-5ecfe8e3.js";const b=e.input`
...
`;function u({value:r,onChange:o,min:t=0,step:x=1,max:a=100,size:n=28,style:d,className:p}){const c=i.useCallback(l=>{o(parseInt(l.target.value))},[o]);return m.jsx(b,{size:n,type:"range",value:r,style:d||{width:"90%",marginLeft:15,marginRight:15,padding:"15px 0"},onChange:c,"aria-labelledby":"input slider",step:x,min:t,max:a,className:p})}const h=e.div`
