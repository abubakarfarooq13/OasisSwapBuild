...
`,N=e=>e?typeof e!="object"?e:e.value??"":"",oe=e=>e?typeof e!="object"?e:e.label||e.value:"",ht=[0,2];function yt({options:e=[],activeRender:t,optionRender:s,style:a={},menuStyle:o={},optionStyle:n={},onChange:r,value:c,className:u,forceMenuPlacementTop:m=!1,arrowColor:p,dropdownRender:i,onHideMenu:d,withSearch:S,placement:h="bottom"}){const[b,y]=f.useState(N(e==null?void 0:e[0])),[w,x]=f.useState(!1),[A,R]=f.useState(""),[v]=f.useState(m);f.useEffect(()=>{var C;const g=(C=e.find(k=>N(k)===c))==null?void 0:C.value;y(g||N(e==null?void 0:e[0]))},[c,e]);const T=f.useRef(null);$e(T,()=>{x(!1),d==null||d()});const I=e.find(g=>N(g)===b),B=()=>e.filter(g=>{var C;return S?(C=g.label)==null?void 0:C.toString().toLowerCase().includes(A.toLowerCase()):!0}).map(g=>{const C=N(g),k=q=>{var Y;q.stopPropagation(),q.preventDefault(),x(!1),R(""),g.onSelect?(Y=g.onSelect)==null||Y.call(g):(y(C),r==null||r(C))};return l.jsx(mt,{role:"button",$selected:C===c||C===N(I),onClick:k,style:n,children:s?s(g):oe(g)},C)}),[L,_]=f.useState(null),{styles:O}=De(T.current,L,{placement:h,strategy:"fixed",modifiers:[{name:"offset",options:{offset:ht}}]});return l.jsxs(pt,{ref:T,role:"button",onClick:()=>{x(g=>!g)},style:a,className:u,children:[l.jsx(St,{children:t?t(I):oe(I)}),l.jsx(Me,{rotate:w,color:p}),l.jsx(Ge,{children:w&&l.jsx(We,{children:l.jsx("div",{ref:_,style:{...O.popper,...v?{bottom:40,top:"unset"}:{},zIndex:Ve.POPOVER_CONTAINER},children:l.jsxs(gt,{initial:{y:-10,opacity:0},animate:{y:0,opacity:1},exit:{y:-10,opacity:0},transition:{duration:.1},style:o,children:[S&&l.jsxs(Ct,{onClick:g=>g.stopPropagation(),children:[l.jsx("span",{style:{position:"absolute",left:"8px"},children:l.jsx(qe,{id:"search"})}),l.jsx("input",{placeholder:Ye._({id:"YIix5Y"}),style:{background:"transparent",outline:"none",border:"none"},value:A,onChange:g=>R(g.target.value)})]}),l.jsx("div",{children:i?i(B()):B()})]})})})})]})}const wt=P(yt)``;function vt({price:e,label:t,icon:s,style:a={},color:o}){const n=ze(),[r,c]=f.useState(!1);let u;try{u=Ke(r?e==null?void 0:e.invert():e,{fractionDigits:4})}catch{}const m=!!(e!=null&&e.baseCurrency&&(e!=null&&e.quoteCurrency)&&u),p=ee(e==null?void 0:e.quoteCurrency),i=ee(e==null?void 0:e.baseCurrency),d=r?`1 ${p==null?void 0:p.symbol} = ${u} ${i==null?void 0:i.symbol}`:`1 ${i==null?void 0:i.symbol} = ${u} ${p==null?void 0:p.symbol}`;return l.jsx(te,{fontWeight:500,fontSize:12,color:o||n.subText,style:{alignItems:"center",display:"flex",cursor:"pointer",...a},onClick:()=>c(!r),height:"22px",children:m?l.jsxs(l.Fragment,{children:[t&&l.jsxs(l.Fragment,{children:[t," "]})," ",l.jsx(te,{color:o,children:d}),l.jsx(Je,{children:s||l.jsx(Qe,{size:12,color:o})})]}):l.jsx(He,{children:l.jsx(Xe,{id:"DCeSWE"})})})}export{E as C,wt as S,vt as T,At as a,Ze as b,ct as c,dt as d,it as e,Tt as f,xt as m,lt as p,se as t,bt as u};
